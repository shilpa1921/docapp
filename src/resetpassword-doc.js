...
export default class ResetPasswordDoctor extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            error: false,
    ...
    submitEmail(e) {
        ...
        axios.post("/resetpassword-doc/step1", this.state).then(({ data }) => {
    ...
    submitcode(e) {
        // e.preventDefault();
        console.log("about to submit", this.state);
        axios.post("/resetpassword-doc/verify", this.state).then(({ data }) => {
            console.log("data: ", data);
            if (data.success) {
                this.setState({
                    step: 3,
            ...
            <div id="password-reset">
                ...
                {this.state.step === 3 && (
                    <div>
                        ...
                        <HashRouter>
                            <div>
                                You can now <Link to="/log-doc">log in</Link>{" "}
